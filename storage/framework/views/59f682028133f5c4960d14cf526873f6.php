<?php $__env->startSection('title', 'Penarikan'); ?>
<?php $__env->startSection('eyebrow', 'Kelola penarikan saldo'); ?>
...
<div style="background:rgba(239,68,68,0.08); border:1px solid rgba(239,68,68,0.2); border-radius:10px; padding:12px 18px; margin-bottom:20px; display:flex; align-items:center; gap:12px;">
    ...
    <div style="font-size:14px; color:#fca5a5;">
        ...
        <a href="<?php echo e(route('account.edit')); ?>" style="color:#60a5fa; font-weight:700; text-decoration:none; margin-left:6px; border-bottom:1px dashed #60a5fa;">Ganti PIN Sekarang →</a>
    </div>
</div>
<?php endif; ?>
...
<div class="grid grid-2" style="margin-bottom:24px;">
    <div class="stack">
        <section class="panel" style="border-color:var(--primary-soft);">
            ...
            <form method="POST" action="<?php echo e(route('withdraw.store')); ?>" class="stack" id="cashierFeeForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="field">
                    ...
                    <input type="number" id="fee_amount" name="amount" min="1000" max="<?php echo e(auth()->user()->withdrawableFees()); ?>" placeholder="Contoh: 15000" required>
        ...
        <section class="panel">
            ...
            <div style="margin-top:20px; display:grid; gap:16px;">
                <div style="display:flex; justify-content:space-between; border-bottom:1px solid var(--line); padding-bottom:8px;">
                    ...
                    <strong>Rp <?php echo e(number_format(auth()->user()->unclaimed_salary, 0, ',', '.')); ?></strong>
                </div>
                <div style="display:flex; justify-content:space-between; border-bottom:1px solid var(--line); padding-bottom:8px;">
                ...
                <div style="display:flex; justify-content:space-between; border-bottom:1px solid var(--line); padding-bottom:8px;">
                    ...
                    <strong style="color:var(--ok); font-size:16px;">Rp <?php echo e(number_format(auth()->user()->withdrawableFees(), 0, ',', '.')); ?></strong>
                </div>
...
<div class="grid grid-2">
    <div class="stack">
        <section class="panel">
            ...
            <form method="POST" action="<?php echo e(route('withdraw.store')); ?>" class="stack" id="withdrawForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="field">
                    ...
                    <select id="amount" name="amount" required>
                        ...
                        <option value="50000" <?php if(old('amount') == '50000'): echo 'selected'; endif; ?>>Rp 50.000</option>
                        <option value="100000" <?php if(old('amount') == '100000'): echo 'selected'; endif; ?>>Rp 100.000</option>
                        <option value="250000" <?php if(old('amount') == '250000'): echo 'selected'; endif; ?>>Rp 250.000</option>
                        <option value="500000" <?php if(old('amount') == '500000'): echo 'selected'; endif; ?>>Rp 500.000</option>
                        <option value="1000000" <?php if(old('amount') == '1000000'): echo 'selected'; endif; ?>>Rp 1.000.000</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="field">
                    ...
                    <select id="method" name="method" required>
                        ...
                        <option value="gopay" <?php if(old('method') == 'gopay'): echo 'selected'; endif; ?>>GoPay</option>
                        <option value="ovo" <?php if(old('method') == 'ovo'): echo 'selected'; endif; ?>>OVO</option>
                        <option value="dana" <?php if(old('method') == 'dana'): echo 'selected'; endif; ?>>DANA</option>
                        <option value="bca" <?php if(old('method') == 'bca'): echo 'selected'; endif; ?>>Bank BCA</option>
                        <option value="mandiri" <?php if(old('method') == 'mandiri'): echo 'selected'; endif; ?>>Bank Mandiri</option>
                    </select>
                </div>
    ...
    <div>
        <section class="panel">
            ...
            <div style="margin-top:20px; text-align:center;">
                ...
                <h1 style="font-size:36px; color:var(--primary); margin:0;">Rp <?php echo e(number_format(auth()->user()->balance, 0, ',', '.')); ?></h1>
            </div>
        </section>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ProyekTI\resources\views/withdraw/index.blade.php ENDPATH**/ ?>