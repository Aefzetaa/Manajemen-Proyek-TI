...
?>
<svg class="<?php echo e($iconClass); ?>" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><?php echo $icons[$iconName] ?? $icons['spark']; ?></svg>


<?php /**PATH C:\laragon\www\ProyekTI\resources\views/components/ui-icon.blade.php ENDPATH**/ ?>