...
<div class="avatar-picker<?php echo e($contained ? ' is-contained' : ''); ?><?php echo e($hasSelectedAvatar ? '' : ' is-empty'); ?>" id="<?php echo e($pickerId); ?>" style="--avatar-picker-size: <?php echo e((int) $size); ?>px;">
    <button type="button" class="avatar-picker-trigger" data-avatar-trigger aria-label="Pilih avatar">
        <img src="<?php echo e($hasSelectedAvatar ? asset('img/' . $selectedAvatar) : ''); ?>" alt="Avatar terpilih" data-avatar-preview style="<?php echo e($hasSelectedAvatar ? '' : 'display:none;'); ?>">
        <span class="avatar-picker-placeholder" data-avatar-placeholder style="<?php echo e($hasSelectedAvatar ? 'display:none;' : ''); ?>">
    ...
    <div class="avatar-picker-orbit" data-avatar-panel>
        <div class="avatar-picker-center" aria-hidden="true">
            <img src="<?php echo e($hasSelectedAvatar ? asset('img/' . $selectedAvatar) : ''); ?>" alt="" data-avatar-center-preview style="<?php echo e($hasSelectedAvatar ? '' : 'display:none;'); ?>">
            <span class="avatar-picker-center-placeholder" data-avatar-center-placeholder style="<?php echo e($hasSelectedAvatar ? 'display:none;' : ''); ?>">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                    <circle cx="12" cy="8" r="4"></circle>
                    <path d="M5 20a7 7 0 0 1 14 0"></path>
                </svg>
        ...
        <?php $__currentLoopData = $leftOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $avatar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $slot = $leftSlots[$index] ?? ['x' => -112, 'y' => 0]; ?>
            <label class="avatar-picker-option" title="<?php echo e($avatar['label']); ?>" style="--avatar-x: <?php echo e($slot['x']); ?>px; --avatar-y: <?php echo e($slot['y']); ?>px;">
                <input type="radio" name="<?php echo e($name); ?>" value="<?php echo e($avatar['value']); ?>" <?php if($hasSelectedAvatar && $selectedAvatar === $avatar['value']): echo 'checked'; endif; ?>>
                <img src="<?php echo e(asset('img/' . $avatar['value'])); ?>" alt="<?php echo e($avatar['label']); ?>">
            </label>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

        <?php $__currentLoopData = $rightOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $avatar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $slot = $rightSlots[$index] ?? ['x' => 112, 'y' => 0]; ?>
            <label class="avatar-picker-option" title="<?php echo e($avatar['label']); ?>" style="--avatar-x: <?php echo e($slot['x']); ?>px; --avatar-y: <?php echo e($slot['y']); ?>px;">
                <input type="radio" name="<?php echo e($name); ?>" value="<?php echo e($avatar['value']); ?>" <?php if($hasSelectedAvatar && $selectedAvatar === $avatar['value']): echo 'checked'; endif; ?>>
                <img src="<?php echo e(asset('img/' . $avatar['value'])); ?>" alt="<?php echo e($avatar['label']); ?>">
            </label>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\ProyekTI\resources\views/components/avatar-picker.blade.php ENDPATH**/ ?>