...
<?php $__env->startSection('body-class', 'public-welcome'); ?>
        ...
        <section id="home" class="welcome-panel hero" data-panel="home">
            <div class="hero-left">
                ...
                <div class="hero-actions">
                    <?php if(auth()->guard()->check()): ?>
                        <a class="btn lg" href="<?php echo e(route('dashboard')); ?>">Dashboard</a>
                    <?php else: ?>
                        <a class="btn lg" href="<?php echo e(route('login')); ?>">Masuk</a>
                        <a class="btn outline lg" href="<?php echo e(route('register')); ?>">Buat Akun</a>
            ...
            <div class="hero-visual" id="heroCarousel">
                ...
                <div class="hero-slide active">
                    <img src="<?php echo e(asset('img/Milky Garage Assets/Office Area.webp')); ?>?v=4" alt="Milky Garage Office">
                ...
                <div class="hero-slide">
                    <img src="<?php echo e(asset('img/Milky Garage Assets/Bar Area.webp')); ?>?v=4" alt="Bar Milky Garage">
                    <div class="slide-overlay">
                        <div class="glass-card">
                ...
                <!-- Slide 3: Cafe -->
                <div class="hero-slide">
                    <img src="<?php echo e(asset('img/Milky Garage Assets/Cafe Area.webp')); ?>?v=4" alt="Cafe Milky Garage">
                    <div class="slide-overlay">
                        <div class="glass-card">
                ...
                <div class="hero-slide">
                    <img src="<?php echo e(asset('img/Milky Garage Assets/Administrartor Area.webp')); ?>?v=4" alt="Administrator">
                    <div class="slide-overlay">
                        <div class="glass-card">
                ...
                <div class="hero-slide">
                    <img src="<?php echo e(asset('img/Milky Garage Assets/Service Area.webp')); ?>?v=4" alt="Service Area">
                    <div class="slide-overlay">
                        <div class="glass-card">
            ...
            <div class="panel-inner">
                ...
                <div class="service-list">
                    <?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <article id="service-<?php echo e($service->id); ?>" class="service-row">
                            <div>
                                <div class="service-title-line">
                                    <h3><?php echo e($service->name); ?></h3>
                                    <?php if($service->hasActiveDiscount()): ?>
                                        <span class="service-discount-badge"><?php echo e($discountPercent); ?>%</span>
                                    <?php endif; ?>
                                </div>
                                <p>Estimasi pengerjaan sekitar <?php echo e($service->estimated_minutes); ?> menit.</p>
                            </div>
                            <div class="service-price">
                                <?php if($service->hasActiveDiscount()): ?>
                                    <span class="service-price-old">Rp <?php echo e(number_format($service->base_price, 0, ',', '.')); ?></span>
                                    <span class="service-price-new">Rp <?php echo e(number_format($discountedPrice, 0, ',', '.')); ?></span>
                                <?php else: ?>
                                    <span class="service-price-new">Rp <?php echo e(number_format($service->base_price, 0, ',', '.')); ?></span>
                                <?php endif; ?>
                            </div>
                        </article>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $activePromotions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <article class="promo-card">
                            <div class="promo-card-main">
                                <span class="promo-badge">Promo <?php echo e($promo->discount_percent); ?>%</span>
                                <h3><?php echo e($promo->title); ?></h3>
                                <p><?php echo e($promo->description ?: 'Promo aktif untuk layanan Milky Garage.'); ?></p>
                                <div class="promo-meta">
                                    <span class="promo-chip"><?php echo e($promo->serviceType?->name ?? 'Semua layanan'); ?></span>
                                    <?php if($promo->ends_at): ?>
                                        <span class="promo-chip">Berlaku sampai <?php echo e($promo->ends_at->format('d M Y')); ?></span>
                                    <?php else: ?>
                                        <span class="promo-chip">Berlaku hari ini</span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="promo-discount-panel" aria-label="Diskon <?php echo e($promo->discount_percent); ?> persen">
                                <div>
                                    <strong><?php echo e($promo->discount_percent); ?>%</strong>
                                    <span>Potongan</span>
                                </div>
                            </div>
                        </article>
...
(function () {
    ...
    async function askZoru(prompt) {
        ...
        try {
            const response = await fetch(<?php echo json_encode(route('zoruai.public'), 15, 512) ?>, {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ProyekTI\resources\views/welcome.blade.php ENDPATH**/ ?>