<?php $__env->startSection('title', 'Top Up'); ?>
<?php $__env->startSection('eyebrow', 'Tambah saldo ZeroPay'); ?>
...
<div class="grid grid-2">
    <div class="stack">
        <section class="panel">
            ...
            <form method="POST" action="<?php echo e(route('topup.store')); ?>" class="stack" id="topupForm">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ProyekTI\resources\views/topup/index.blade.php ENDPATH**/ ?>