...
<head>
    ...
    <title>@yield('title', 'Milky Garage') | Milky Garage</title>
    <link class="favicon" rel="icon" type="image/webp" href="{{ asset('img/Milky Garage Assets/Logo Area.webp') }}">
...
<body class="@yield('body-class')">
    ...
    <nav class="pub-nav">
        <a href="{{ route('welcome') }}" class="pub-brand">
            <span class="pub-brand-mark">
                <img src="{{ asset('img/Milky Garage Assets/Logo Area.webp') }}" alt="Milky Garage Logo">
            </span>
            <span>Milky Garage</span>
        </a>
        <div class="pub-nav-menu">
            <a class="pub-nav-link" href="{{ route('welcome') }}#home">Home</a>
            <a class="pub-nav-link" href="{{ route('welcome') }}#layanan">Layanan</a>
            <a class="pub-nav-link" href="{{ route('welcome') }}#promo">Promo</a>
            <a class="pub-nav-link" href="{{ route('welcome') }}#tentang">Tentang Kami</a>
        </div>
